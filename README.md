...
新 agent / 换电脑继续开发前先读 **[AGENTS.md](./AGENTS.md)**（目标、键位、代按、已知坑、Windows 打 exe 任务）。

这是一个可直接在浏览器打开的单文件口风琴模拟器，也可用 Electron 做透明跟谱和系统代按。
...
不要只给 `index.html`。把整个仓库打开，并让它先读 `AGENTS.md`。
